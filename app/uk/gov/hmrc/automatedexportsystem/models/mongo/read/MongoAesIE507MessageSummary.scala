...
package uk.gov.hmrc.automatedexportsystem.models.mongo.read
...
import uk.gov.hmrc.automatedexportsystem.models.mongo.write.NotificationEvent

import java.time.Instant

final case class MongoAesIE507MessageSummary(
  submissionId:              SubmissionId,
  exportOperation:           ExportOperation,
  customsOfficeOfExitActual: CustomsOfficeOfExitActual,
  ducr:                      Option[ReferenceNumberUcr],
  latestNotification:        Option[NotificationEvent],
  updatedAt:                 Instant
)
...
object MongoAesIE507MessageSummary:
  ...
  val mongoFormat: Format[MongoAesIE507MessageSummary] = Json.format[MongoAesIE507MessageSummary]
