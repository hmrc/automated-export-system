...
object ShippingMarks:
  ...
  given shippingMarksXmlWriter: XmlWriter[ShippingMarks] =
    (o, label) => o.value.toXml(label)

  given shippingMarksXmlReader: XmlReader[ShippingMarks] =
    XmlReader.stringReader.map(ShippingMarks.apply)
