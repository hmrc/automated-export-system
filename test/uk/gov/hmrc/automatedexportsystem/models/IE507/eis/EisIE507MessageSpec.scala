...
class EisIE507MessageSpec extends AnyFreeSpecLike, Matchers:
  object TestData:
    ...
    val eisIE507Header: EisIE507Header = EisIE507Header(
    ...
    val eisIE507Message: EisIE507Message =
      EisIE507Message(
    ...
    end eisIE507MessageNoGoodsShipmentChildrenOptionals

    val eisIE507MessageNoGoodsShipment: EisIE507Message =
      EisIE507Message(
        header = eisIE507Header,
        body = EisIE507Body(
          exportOperation = ExportOperation(
  ...
  "EisIE507Message" - {
    ...
    "should be able to be serialized to XML" - {
      ...
      "when all fields are present, and lists are populated with more than one element" in {
        val xml: Elem =
          <n:CC507C xmlns:n="http://ecs.dgtaxud.ec">
            <Header>
              <messageSender>messageSender</messageSender>
              <messageRecipient>messageRecipient</messageRecipient>
              <preparationDateAndTime>2026-08-21T00:00:00</preparationDateAndTime>
              <messageIdentification>messageIdentification</messageIdentification>
              <messageType>messageType</messageType>
            </Header>
            <Body>
        ...
        XmlOps.normalize(TestData.eisIE507Message.toXmlRoot) shouldBe XmlOps.normalize(xml)
      }
      ...
      "when GoodsShipment children optional fields are missing" in {
        ...
        XmlOps.normalize(TestData.eisIE507MessageNoGoodsShipmentChildrenOptionals.toXmlRoot) shouldBe XmlOps.normalize(xml)
      }
      ...
      "when GoodsShipment is missing" in {
        ...
        XmlOps.normalize(TestData.eisIE507MessageNoGoodsShipment.toXmlRoot) shouldBe XmlOps.normalize(xml)
      }
    }
  }
